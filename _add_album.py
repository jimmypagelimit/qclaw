...
VALUES (?, ?, ?, ?, ?, ?, ?, ?)''', 
(new_id, 'Vol.II', 'Angine de Poitrine', '2026', 'Math Rock', 3.58, 1, 'France'))
...
VALUES (?, ?, ?, ?, ?, ?, ?, ?)''', 
(new_2026_id, 'Vol.II', 'Angine de Poitrine', '2026', 'Math Rock', 3.58, 1, 'France'))

conn.commit()
print('Database updated')

# 下载封面
cover_url = 'https://is1-ssl.mzstatic.com/image/thumb/Music211/v4/54/91/db/5491db35-84a9-b4e5-83cc-b52fdf678bb2/11115.jpg/600x600bb.jpg'
os.makedirs(covers_dir, exist_ok=True)
cover_path = os.path.join(covers_dir, f'{new_id}-Angine_de_Poitrine-Vol_II.jpg')
