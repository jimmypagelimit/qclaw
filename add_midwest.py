...
# -*- coding: utf-8 -*-
"""
添加 midwest, post death - Post Recovery 到数据库
"""
import sqlite3
import os
...
lines.append('=== 新增专辑：midwest, post death - Post Recovery ===')
lines.append('')
...
""", (
    ...
    None,
    f'covers/{new_id}-midwest_post_death-Post_Recovery.jpg',
    None,
    None,
    None,
    None,
    ...
    None,
    None,
    '2026-03-13',  # release_year (TEXT 类型)
    None,
    None
))
...
""", (
    ...
    None,
    f'covers/{new_id_2026}-midwest_post_death-Post_Recovery.jpg',
    None,
    None,
    None,
    None,
...
lines.append('')
lines.append('=== 下一步 ===')
lines.append(f'1. 下载封面到: covers/{new_id}-midwest_post_death-Post_Recovery.jpg 和 covers/{new_id_2026}-midwest_post_death-Post_Recovery.jpg')
...
with open(r'C:\Users\qujt\.qclaw\workspace\add_midwest_result.txt', 'w', encoding='utf-8') as f:
    f.write(output)

print('Done, saved to add_midwest_result.txt')
