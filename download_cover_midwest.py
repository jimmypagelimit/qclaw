...
# -*- coding: utf-8 -*-
"""
下载 midwest, post death - Post Recovery 封面
"""
...
fname1 = '531-midwest_post_death-Post_Recovery.jpg'
fname2 = '187-midwest_post_death-Post_Recovery.jpg'
...
with open(r'C:\Users\qujt\.qclaw\workspace\download_cover_midwest.txt', 'w', encoding='utf-8') as f:
    f.write(output)

print('Done, saved to download_cover_midwest.txt')
