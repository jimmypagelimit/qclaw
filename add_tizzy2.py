...
# -*- coding: utf-8 -*-
"""
添加 Tizzy Bac - 如果看見地獄，我就不怕魔鬼 到数据库
"""
import sqlite3
import os
...
lines.append('=== 新增专辑：Tizzy Bac - 如果看見地獄，我就不怕魔鬼 ===')
lines.append('')
...
""", (
    ...
    0,
    '2026-05',  # 首次听歌时间
    5,  # total_listen_count (听 5 次)
    None,
    f'covers/{new_id}-Tizzy_Bac-如果看見地獄，我就不怕魔鬼.jpg',
    None,
    None,
    None,
    None,
    ...
    None,
    None,
    '2009-02-13',  # release_year (TEXT 类型)
    None,
    None
))
...
""", (
    ...
    0,
    '2026-05',  # 首次在 2026 年听
    5,  # total_listen_count (2026 年听 5 次)
    None,
    f'covers/{new_id_2026}-Tizzy_Bac-如果看見地獄，我就不怕魔鬼.jpg',
    None,
    None,
    None,
    None,
...
lines.append('')
lines.append('=== 下一步 ===')
lines.append(f'1. 下载封面到: covers/{new_id}-Tizzy_Bac-如果看見地獄，我就不怕魔鬼.jpg 和 covers/{new_id_2026}-Tizzy_Bac-如果看見地獄，我就不怕魔鬼.jpg')
...
with open(r'C:\Users\qujt\.qclaw\workspace\add_tizzy2_result.txt', 'w', encoding='utf-8') as f:
    f.write(output)

print('Done, saved to add_tizzy2_result.txt')
