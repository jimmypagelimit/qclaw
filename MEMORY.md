...
## 音乐库
- 源目录: `\\\\10.0.2.4\\qemu\\音乐编年史`（已不可达，Windows VM 下线）
- 岁月新歌: `\\\\10.0.2.4\\qemu\\diary-content\\history\\music\\list\\岁月新歌\\（2005-2024）`（已不可达）
- 岁月拾歌: `\\\\10.0.2.4\\qemu\\diary-content\\history\\music\\list\\岁月拾歌\\（2008-2024）`（已不可达）
