...
# -*- coding: utf-8 -*-
"""
添加 otay:onii - 愛在屎邊邊 Love Is in the Shit 到数据库
"""
import sqlite3
import os
...
lines.append('=== 新增专辑：otay:onii - 愛在屎邊邊 Love Is in the Shit ===')
lines.append('')
...
c.execute("""
    INSERT INTO albums (
        ...
        cover_image_url, composition_score, lyrics_meaning_score,
...
""", (
    ...
    None,
    f'covers/{new_id}-otay_onii-愛在屎邊邊_Love_Is_in_the_Shit.jpg',
    None,
    None,
    None,
    None,
    ...
    None,
    None,
    '2026-05-08',  # release_year (TEXT 类型)
    None,
    None
))
...
""", (
    ...
    None,
    f'covers/{new_id_2026}-otay_onii-愛在屎邊邊_Love_Is_in_the_Shit.jpg',
    None,
    None,
    None,
    None,
...
lines.append('')
lines.append('=== 下一步 ===')
lines.append(f'1. 下载封面到: covers/{new_id}-otay_onii-愛在屎邊邊_Love_Is_in_the_Shit.jpg 和 covers/{new_id_2026}-otay_onii-愛在屎邊邊_Love_Is_in_the_Shit.jpg')
...
with open(r'C:\Users\qujt\.qclaw\workspace\add_otay_result.txt', 'w', encoding='utf-8') as f:
    f.write(output)

print('Done, saved to add_otay_result.txt')
