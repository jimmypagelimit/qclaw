...
album_name = '如果看見地獄，我就不怕魔鬼'
artist = 'Tizzy Bac'

covers_dir = r'C:\Users\qujt\.qclaw\workspace\tasks\2026-05-12-long-term-project\album-tracker\covers'
fname1 = '529-Tizzy_Bac-如果看見地獄，我就不怕魔鬼.jpg'
fname2 = '185-Tizzy_Bac-如果看見地獄，我就不怕魔鬼.jpg'
...
with open(r'C:\Users\qujt\.qclaw\workspace\download_cover_tizzy2.txt', 'w', encoding='utf-8') as f:
    f.write(output)

print('Done, saved to download_cover_tizzy2.txt')
