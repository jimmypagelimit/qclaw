...
fname1 = '528-Maria_BC-Marathon.jpg'
fname2 = '184-Maria_BC-Marathon.jpg'
...
with open(r'C:\Users\qujt\.qclaw\workspace\download_cover_maria.txt', 'w', encoding='utf-8') as f:
    f.write(output)

print('Done, saved to download_cover_maria.txt')
