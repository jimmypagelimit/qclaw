...
# Download full res version (500x500 from iTunes)
...
# Update DB cover path
import sqlite3
DB = r'C:\Users\qujt\.qclaw\workspace\_music_latest.db'
conn = sqlite3.connect(DB)
cur = conn.cursor()
cur.execute("UPDATE albums SET cover_image_url = ? WHERE album_id = ?", ('/covers/558-Tizzy_Bac-夏季热.jpg', 558))
conn.commit()
conn.close()
print("DB updated")
