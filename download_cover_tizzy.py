...
# -*- coding: utf-8 -*-
"""
下载 Tizzy Bac - 告密的心 (The Tell-Tale Heart) 封面
...
album_name = '告密的心 The Tell-Tale Heart'
artist = 'Tizzy Bac'

covers_dir = r'C:\Users\qujt\.qclaw\workspace\tasks\2026-05-12-long-term-project\album-tracker\covers'
fname1 = '527-Tizzy_Bac-告密的心_The_Tell-Tale_Heart.jpg'
fname2 = '182-Tizzy_Bac-告密的心_The_Tell-Tale_Heart.jpg'
...
with open(r'C:\Users\qujt\.qclaw\workspace\download_cover_tizzy.txt', 'w', encoding='utf-8') as f:
    f.write(output)

print('Done, saved to download_cover_tizzy.txt')
